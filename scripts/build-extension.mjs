...
const manifest={manifest_version:3,name:'Mimic — Browser Companion',version:'2.0.0',minimum_chrome_version:'125',description:'Record a browser workflow, learn its inputs, and replay it from your Mimic dashboard. No local server.',key:identity.key,permissions:['debugger','storage','tabs'],background:{service_worker:'background.js',type:'module'},action:{default_title:'Open Mimic'},externally_connectable:{matches:origins.map(o=>`${o}/*`)}};

...
async function handle(message,sender){
  ...
  if(path==='/state'&&method==='GET')return {...store.data,...engine.status(),token:'extension-managed',practiceUrl:`${identity.dashboardOrigin}/practice`,version:'4.0.0',connected:true,capabilities:['outcomes','repair-tests','batches','side-panel','visual-outcomes','current-tab'],batchActive:batch.active};
